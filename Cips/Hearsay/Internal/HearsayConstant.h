...
#define HEARSAY_USER_REPORT_LIST @"report_user_list"
#define HEARSAY_OFFENSIVE_STATUS @"ow_status_get"
#define HEARSAY_OFFENSIVE_SET @"ow_status_set"
#define HEARSAY_OFFENSIVE_LIST @"ow_list_get"
#define HEARSAY_OFFENSIVE_ADD @"ow_list_add"`
